...
public class AsientoPanel extends JPanel {
    ...
    private void buildRightPanel() {
        ...
        simTitle.setFont(new Font("Dialog", Font.BOLD, 27));
        ...
        btnSimularCancelacion.setFont(new Font("Dialog", Font.BOLD, 25));
        ...
        btnSimularCancelacion.setMaximumSize(new Dimension(435, 78));
    ...
    private void buildBottomPanel() {
        ...
        statusLabel.setFont(new Font("Dialog", Font.PLAIN, 25));
