...
public class EquipajePanel extends JPanel {
    ...
    private void buildRightPanel() {
        ...
        rightPanel.setBorder(BorderFactory.createCompoundBorder(
                ...
                BorderFactory.createEmptyBorder(15, 15, 15, 27)
        ));
        rightPanel.setPreferredSize(new Dimension(495, 0));

        JLabel transitionTitle = new JLabel("Transici\u00f3n de Estado");
        transitionTitle.setFont(new Font("Dialog", Font.BOLD, 27));
        ...
        comboLabel.setFont(new Font("Dialog", Font.PLAIN, 24));
        ...
        estadoComboBox.setFont(new Font("Dialog", Font.PLAIN, 25));
        estadoComboBox.setMaximumSize(new Dimension(435, 63));
        ...
        btnActualizarEstado.setFont(new Font("Dialog", Font.BOLD, 25));
        ...
        btnActualizarEstado.setMaximumSize(new Dimension(435, 72));
        ...
        separator.setMaximumSize(new Dimension(435, 1));
        ...
        historialLabel.setFont(new Font("Dialog", Font.BOLD, 27));
        ...
        btnHistorial.setFont(new Font("Dialog", Font.BOLD, 25));
        ...
        btnHistorial.setMaximumSize(new Dimension(435, 72));
    ...
    private void buildBottomPanel() {
        ...
        bottomPanel.setPreferredSize(new Dimension(0, 108));

        statusLabel = new JLabel("  Total equipajes: 0");
        statusLabel.setFont(new Font("Dialog", Font.PLAIN, 24));
        ...
        qrLabel.setFont(new Font("Dialog", Font.ITALIC, 24));
    ...
    private void mostrarHistorial() {
        ...
        dialogTitle.setFont(new Font("Dialog", Font.BOLD, 28));
        ...
        btnCerrar.setFont(new Font("Dialog", Font.BOLD, 25));
        btnCerrar.setPreferredSize(new Dimension(225, 63));
